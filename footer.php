		<div class="footer content_box">
			...
			<div class="footer_infos boxes">
					<h4>Adresse</h4>
					<p>Rue Ten-Eycken 74</br>4850 Plombières BELGIUM</p>
			</div>
			<div class="footer_infos boxes">
					<h4>Me suivre</h4>
					<ul class="social_media">
						<li><a href="https://www.facebook.com/marcel.pirnay">
							<div title="Code: 0xe818" class="the-icons span3"><i class="icon-facebook-squared"></i></div>
						</a></li>
						<li><a href="https://twitter.com/Marss2601">
							<div title="Code: 0xe812" class="the-icons span3"><i class="icon-twitter"></i></div>
						</a></li>
						<li><a href="http://instagram.com/mars2622">
							<div title="Code: 0xe821" class="the-icons span3"><i class="icon-instagram"></i></div>
						</a></li>
						<li><a href="http://fr.pinterest.com/marcelpirnay/">
							<div title="Code: 0xe814" class="the-icons span3"><i class="icon-pinterest"></i></div>
						</a></li>
						<li><a href="https://www.linkedin.com/profile/view?id=186266873&trk=nav_responsive_tab_profile_pic">
